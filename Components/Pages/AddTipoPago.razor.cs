...
{
    public partial class AddTipoPago
    {
        [Inject]
        ...
        {
            tipoPago = new SistemaBushidoSushiWok.Models.BUSHIDOSUSHIWOK.TipoPago();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await BUSHIDOSUSHIWOKService.CreateTipoPago(tipoPago);
