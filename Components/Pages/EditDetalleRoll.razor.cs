...
{
    public partial class EditDetalleRoll
    {
        [Inject]
        ...
        {
            detalleRoll = await BUSHIDOSUSHIWOKService.GetDetalleRollByRollId(RollId);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await BUSHIDOSUSHIWOKService.UpdateDetalleRoll(RollId, detalleRoll);
