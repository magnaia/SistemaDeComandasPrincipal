...
{
    public partial class AddTrabajador
    {
        [Inject]
        ...
        {
            trabajador = new SistemaBushidoSushiWok.Models.BUSHIDOSUSHIWOK.Trabajador();
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await BUSHIDOSUSHIWOKService.CreateTrabajador(trabajador);
